...
var guiControls=new function(){
	...
	this.distance=1; // There is some problem. This variable is not shown in the screen, but there is no need of the given variable.
...
datGUI.add(guiControls,'distance',0,10,1);
